...
<head>
    ...
    <div class="container text-center">
        <p class="h3">修改留言 <small><a href="../front/list.php">查看留言</a></small></p>
    </div>
</head>
<body>
<div class="container">
    <form action="../backend/update_back.php" role="form" class="form-horizontal" enctype="multipart/form-data"
          method="post" onsubmit="return checkError()">
        <div class="form-group">
            <label for="name" class="col-md-offset-2 col-md-2 control-label">留言标题</label>
            <div class="col-md-5">
        ...
        <div class="form-group">
            <label for="content" class="col-md-offset-2 col-md-2 control-label">留言内容</label>
            <div class="col-md-5">
